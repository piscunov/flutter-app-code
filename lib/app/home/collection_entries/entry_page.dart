...
import 'package:flutterapp/app/home/collection_entries/date_time_picker.dart';
...
class EntryPage extends StatefulWidget {
  const EntryPage({@required this.database, @required this.collection, this.entry});
  final Collection collection;
  final Entry entry;
  final Database database;

  static Future<void> show({BuildContext context, Database database, Collection collection, Entry entry}) async {
    await Navigator.of(context, rootNavigator: true).push(
      MaterialPageRoute(
        builder: (context) =>
            EntryPage(database: database, collection: collection, entry: entry),
